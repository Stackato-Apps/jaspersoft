...
<t:insertTemplate template="/WEB-INF/jsp/templates/page.jsp">
    ...
    <t:putAttribute name="headerContent" >
        <script type="text/javascript" language="JavaScript" src="${pageContext.request.contextPath}/scripts/messages.messageList.js"></script>
    </t:putAttribute>
    <t:putAttribute name="bodyContent" >
            ...
            <t:putAttribute name="headerContent">
                ...
                <div id="toolbar" class="toolbar">
                    <ul class="list buttonSet">
                        <li class="leaf"><button id="markAsRead" class="button capsule up first"><span class="wrap"><spring:message code="messages.messageList.toolbar.button.markAsRead"/></span><span class="icon"></span></button></li>
                        <li class="leaf"><button id="markAsUnread" class="button capsule up last"><span class="wrap"><spring:message code="messages.messageList.toolbar.button.markAsUnread"/></span><span class="icon"></span></button></li>
                        <li class="leaf separator"></li>
                        <li class="leaf"><button id="delete" class="button capsule up"><span class="wrap"><spring:message code="messages.messageList.toolbar.button.delete"/></span></button></li>
                    </ul>
                </div>
            </t:putAttribute>
            <t:putAttribute name="bodyContent">
        ...
        <jsp:include page="messageListState.jsp"/>
    </t:putAttribute>
</t:insertTemplate>
