	...
	<div class="swfWrapper">
		<object class="swfExport" >
			<param name="wmode" value="transparent">
		  	<param name="movie" value="jasperreports-flash-4.5.0.swf"/>
            <param name="FlashVars" value="jrpxml=jrpxml?jrprint=${jasperPrintName}">
		  	<embed src="jasperreports-flash-4.5.0.swf" FlashVars="jrpxml=jrpxml?jrprint=${jasperPrintName}" width="100%" height="100%" wmode="transparent"></embed>
		</object>
	</div>
</body>
