    ...
    <t:putAttribute name="bodyContent" >
		...
		<tbody>
				...
				<tr class="">
					...
					<td><div class="toolbar"><button class="button capsule up"><span class="wrap"><spring:message code="JIF.label"/></span><span class="icon"></span></button></div></td>
					<td><div class="toolbar"><button class="button capsule up over"><span class="wrap"><spring:message code="JIF.label"/></span></div></button></td>
					<td><div class="toolbar"><button class="button capsule up pressed"><span class="wrap"><spring:message code="JIF.label"/></span></div></button></td>
					<td><div class="toolbar"><button class="button capsule disabled"><span class="wrap"><spring:message code="JIF.label"/></span></div></button></td>
					<td><div class="toolbar"><button class="button capsule down"><span class="wrap"><spring:message code="JIF.label"/></span></div></button></td>
					<td><div class="toolbar"><button class="button capsule down over"><span class="wrap"><spring:message code="JIF.label"/></span></div></button></td>
					<td><div class="toolbar"><button class="button capsule down pressed"><span class="wrap"><spring:message code="JIF.label"/></span></div></button></td>
				</tr>
				</tbody>
					...
					<td colspan="7">
						<div class="toolbar">		        					
							<ul class="list buttonSet">
		    					<li class="leaf"><button class="button capsule up first"><span class="wrap"><spring:message code="JIF.labelup"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule up over middle"><span class="wrap"><spring:message code="JIF.labelupover"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule up pressed middle"><span class="wrap"><spring:message code="JIF.labeluppressed"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule up disabled middle"><span class="wrap"><spring:message code="JIF.labelupdisabled"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule down over middle"><span class="wrap"><spring:message code="JIF.labeldownover"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule down pressed middle"><span class="wrap"><spring:message code="JIF.labeldownpressed"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule down last"><span class="wrap"><spring:message code="JIF.labeldown"/></span><span class="icon"></span></button></li>
								<li class="leaf separator"></li>
		    					<li class="leaf"><button class="button capsule down first"><span class="wrap"><spring:message code="JIF.labeldown"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule down disabled middle"><span class="wrap"><spring:message code="JIF.labeldowndisabled"/></span><span class="icon"></span></button></li>
		    					<li class="leaf"><button class="button capsule up last"><span class="wrap"><spring:message code="JIF.labelup"/></span><span class="icon"></span></button></li>
		    					<li class="leaf separator"></li>
		    					<li class="leaf"><button class="button capsule down"><span class="wrap"><spring:message code="JIF.labeldown"/></span><span class="icon"></span></button></li>
							</ul>		
						</div>
					</td>
				</tr>
