...
<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
    ...
    <t:putAttribute name="containerClass">panel dialog overlay moveable sizeable centered_horz centered_vert showingSubHeader permissions ${containerClass}</t:putAttribute>
